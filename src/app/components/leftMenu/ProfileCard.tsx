        ...
        <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
            ...
            <div className='h-20 flex flex-col gap-2 items-center'>
                ...
                <div className="flex items-center gap-4">
                    <div className="flex">
                        <Image src="https://images.pexels.com/photos/26821465/pexels-photo-26821465/free-photo-of-the-wooden-stairs-to-the-lake.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                        alt=""
                        width={12}
                        height={12}  
