...
const CommentList = ({comments,postId}
    :{comments:CommentWithUser[];
        ...
        const [optimisticComments, addOptimisticComments] = useOptimistic(commentState,
            ...
            <div className="">
               ...
               {optimisticComments.map(comment=>(
                ...
                <div className="flex gap-4 justify-between mt-6" key={comment.id}>
                    {/* AVATAR */}
                    <img src={comment.user.avatar || "noAvatar.png"}
                        alt="" 
                        width={40} 
                        height={40} 
                    ...
                    <div className="flex flex-col gap-2 flex-1">
                        <span className="font-medium">
                            ...
                            comment.user.name + " " + comment.user.surname : comment.user.username}</span>
                        <p>{comment.desc}</p>
